...
static OP_NAMES: &'static [OpProp; OP_NOP as usize + 1] = &[
    OpProp {
        ...
        is_test: false,
        set_reg_a: true,
        mode_arg_b: OpArgMode::R,
        mode_arg_c: OpArgMode::N,
        typ: OpType::ABC,
    },
    OpProp {
        name: "MOVEN",
    ...
    OpProp {
        ...
        is_test: false,
        set_reg_a: true,
        mode_arg_b: OpArgMode::U,
        mode_arg_c: OpArgMode::U,
        typ: OpType::ABC,
    },
    OpProp {
        name: "LOADNIL",
